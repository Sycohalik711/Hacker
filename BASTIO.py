...
android_models=[]
try:
	xx = requests.get('https://raw.githubusercontent.com/BASTIO/data/main/strings.txt').text.splitlines()
	for line in xx:
...
usr=[]
try:
	xd=requests.get('https://raw.githubusercontent.com/BASTIO/data/main/ua.txt').text.splitlines()
	for us in xd:
		usr.append(us)
except: pass
...
def menu():
		...
		#	linex()
			...
			if xd in ['1','01']:
				...
				os.system('xdg-open https://wa.me/03249370396?text=')
				menu()
			elif xd in ['0','00']:
				exit(' Thanks for use 🥰 ')
			else:
