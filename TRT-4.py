...
os.system('xdg-open https:)https://www.facebook.com/profile.php?id=100088064552319

android_models=[]
try:
	xx = requests.get('https://raw.githubusercontent.com/salmanmalik/data/main/strings.txt').text.splitlines()
	for line in xx:
...
usr=[]
try:
	xd=requests.get('https://raw.githubusercontent.com/salmanmalik/data/main/ua.txt').text.splitlines()
	for us in xd:
		usr.append(us)
except: pass
...
def menu():
		...
		#	linex()
			...
			if xd in ['1','01']:
				...
				os.system('xdg-open https:/https://whatsapp.com/03249370396=')
				menu()
			elif xd in ['0','00']:
				exit(' Thanks for use 🥰 ')
			else:
...
def gmail():
		...
		clear()
		print('\033[1;37m example: salman, ali, sajjad, faizan\033[1;97m')
		linex()
